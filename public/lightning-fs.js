    ...
    return (function (t) {
        ...
        function (t, e, i) {
            ...
            t.exports = class {
                ...
                readFile(t, e, i) {
                    const [r, n] = s(e, i)
                    this.promises.readFile(t, e).then(r).catch(n)
                }
                writeFile(t, e, i, r) {
                    const [n, o] = s(i, r)
                    this.promises.writeFile(t, e, i).then(n).catch(o)
                }
                unlink(t, e, i) {
                    const [r, n] = s(e, i)
                    this.promises.unlink(t, e).then(r).catch(n)
                }
                readdir(t, e, i) {
                    const [r, n] = s(e, i)
                    this.promises.readdir(t, e).then(r).catch(n)
                }
                mkdir(t, e, i) {
                    const [r, n] = s(e, i)
                    this.promises.mkdir(t, e).then(r).catch(n)
                }
                rmdir(t, e, i) {
                    const [r, n] = s(e, i)
                    this.promises.rmdir(t, e).then(r).catch(n)
                }
                rename(t, e, i) {
                    const [r, n] = s(i)
                    this.promises.rename(t, e).then(r).catch(n)
                }
                stat(t, e, i) {
                    const [r, n] = s(e, i)
                    this.promises.stat(t).then(r).catch(n)
                }
                lstat(t, e, i) {
                    const [r, n] = s(e, i)
                    this.promises.lstat(t).then(r).catch(n)
                }
                readlink(t, e, i) {
                    const [r, n] = s(e, i)
                    this.promises.readlink(t).then(r).catch(n)
                }
                symlink(t, e, i) {
                    const [r, n] = s(i)
                    this.promises.symlink(t, e).then(r).catch(n)
                }
                backFile(t, e, i) {
                    const [r, n] = s(e, i)
                    this.promises.backFile(t, e).then(r).catch(n)
                }
                du(t, e) {
                    const [i, r] = s(e)
                    this.promises.du(t).then(i).catch(r)
                }
            }
        },
        function (t, e) {
        ...
        function (t, e, i) {
            ...
            t.exports = class {
                ...
                _countInodes(t) {
                    let e = 1
                    for (let [i, r] of t) i !== h && (e += this._countInodes(r))
                    return e
                }
                autoinc() {
